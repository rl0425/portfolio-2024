  ...
  gantt_chart: {
    ...
    mainDescription: (
      <p>
        ...
        사의 간트 차트를 활용하여 PPM(프로젝트 포트폴리오 관리)에 필요한 모든
        태스크 일정, 이벤트, 프로젝트와 사용자 간의 관계를 시각적으로 표현하는
        페이지를 기획하고 개발함. 이 페이지는 프로젝트 관리의 효율성을
        극대화하며, 사용자들이 프로젝트의 진행 상황을 직관적으로 이해할 수
        있도록 지원함
      </p>
    ),
    image: {
    ...
    description: [
      {
        ...
        description: [
          ...
          <p key="1">
            <span className="font-semibold underline">
              DHTMLX Gantt 라이브러리를 자사의 솔루션 프로그램에 맞게 설계 및
              커스터마이징하여, 직관적이고 효율적인 프로젝트 관리 도구를 제공함.
            </span>
            태스크, 마일스톤, 일정 그래픽 차트 및 실시간 수정 서비스를
            개발함으로써, 프로젝트 포트폴리오 관리(PPM)에서 핵심적인 역할을
            수행하며 팀원들이 진행 상황을 명확히 파악하고 신속하게 의사 결정을
            내릴 수 있도록 지원함.
          </p>,
        ],
      },
      {
        ...
        description: [
          <p key="0">
            기존 라이브러리 기반의 데모 코드를 개선하여{" "}
            <span className="underline">
              API 통신 속도를 300% 향상시키고, 기능 개수를 200% 증가시키는
            </span>{" "}
            등 성능을 대폭 개선함
          </p>,
          <p key="1">
      ...
      //     "차트 인터페이스를 개선하여 시각적으로 더 직관적이고 사용하기 쉽게 만들어 사용자 편의성을 강화함",
      //   ],
      // },
      {
        title: "문서화 및 설계",
        description: [
          <p key="0">
            ...
            유지보수성과 팀 협업의 효율성을 증대시킴
          </p>,
          <p key="1">
            간트 차트에 들어가는 태스크와 마일스톤의 모든 경우의 수를 미리
            예측하여 상태를 나누고 관리하는 설계를 진행하며, 완료된 태스크,
            지연된 태스크, 태스크 간의 종속성 설정 등 다양한 상태를 체계적으로
            관리함
          </p>,
          <p key="2">
            마일스톤 또한 동일한 방식으로 관리되어 지연된 기간에 따라 시각적으로
            연장되어 표시되도록 설계하며, 태스크/마일스톤의 상태를 나타내기 위한
            조건을 정교하게 정의하고 이를 코드에서 효과적으로 모듈화하여
            관리함으로써 구조를 명확히 하여 유지보수성과 가독성을 높임
          </p>,
        ],
      },
      {
        ...
        description: [
          <p key="0">
            프로젝트 내 모든 태스크와 마일스톤을 통합적으로 관리하고 제어할 수
            있는 기능을 성공적으로 구현함.
          </p>,
          <p key="1">
            기존 간트차트 페이지 대비{" "}
          ...
          <p key="2">
            가장 첫 번째로 들어오는 페이지를 제외하고, 간트 차트 기능을 도입한
            이후 다른 기능들(예산, 칸반 보드, 마인드맵, 피드 등)을 포함하여 가장
            많은 PV를 기록함
          </p>,
        ],
      },
