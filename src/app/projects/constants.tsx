      ...
      },
      {
        ...
        description: [
          ...
          <p key="1">
            ...
            <br />- 고객사의 기능 요청 반영률을 90% 이상 달성 하는 등 고객사
    ...
    description: [
      {
        ...
        description: [
          ...
          <p key="2">
            높은 완성도로 서비스 사용량을 증대하며 창업진흥원 소속 다수 기업의
            접근성과 실사용률을 확보 하는 실질적인 비즈니스 성과 달성
          </p>,
        ],
      },
      {
      ...
      },
      {
        ...
        description: [
          <p key="0">
            ...
            팀에서 스프린트 계획 수립 및 일정 관리를 하는 등{" "}
            <span className="underline">
              프로젝트 매니저로서의 역할을 성공적으로 수행
            </span>{" "}
          </p>,
          <p key="1">
            프로젝트 일정, 리소스, 인력을 체계적으로 관리, 일정 준수율 100%를
            달성하며 전반적인 진행을 원활하게 이끌어냄
          </p>,
          <p key="2">
