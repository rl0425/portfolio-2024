      ...
      },
      {
        ...
        description: [
          <p key="0">
            ...
            이해할 수 있도록 지원함 역상승 그래프 및 태스크·마일스톤 테이블
            서비스를 개발하여, 데이터의 시각적 표현을 통해 사용자가 프로젝트
            진행 상황과 결과를 직관적으로 이해할 수 있도록 지원함
          </p>,
        ],
      },
      {
      ...
      },
      {
        ...
        description: [
          <p key="0">
            ...
            사용자들은 프로젝트의 성공 여부를 명확하게 판단할 수 있음 제공하여
            자사 PPM 시스템의 활용성과 기능성을 증대시킴. 이를 통해 사용자들은
            프로젝트의 성공 여부를 명확하게 판단할 수 있음
          </p>,
        ],
      },
      {
      ...
      },
      {
        ...
        description: [
          <p key="0">
            ...
            프로젝트 관리의 효율성을 제고함. 활용도를 극대화함. 이를 통해
            사용자는 프로젝트의 진행 상황을 한눈에 파악할 수 있으며, 참여자의
            프로젝트 참여율과 완성률에 대한 평가도 제공됨. <br />
            또한, 팀원 간의 상호 평가 및 댓글 기능을 통해 협업의 질을 높이고,
            초기 프로젝트 목표 달성 비율 및 실패 비율을 명확히 보여줌으로써
            프로젝트 관리의 효율성을 제고함.
          </p>,
          ...
          <p key="0">
            <ul>
              <li>
                ...
                효율적인 커뮤니케이션을 지원함 Comments : 카테고리별 특성을
                고려한 댓글 시스템을 구현하여 효율적인 커뮤니케이션을 지원함
              </li>
              <li>
                Goals : 프로젝트 목표 달성도에 대한 실시간 평가 및 피드백을
                제공하여 목표 관리의 투명성을 높임 Goals : 프로젝트 목표
                달성도에 대한 실시간 평가 및 피드백을 제공하여 목표 관리의
                투명성을 높임
              </li>
              <li>
                Task : 개별 태스크 진행 상황을 공유하고 이슈를 논의할 수 있는
                기능을 제공함 Task : 개별 태스크 진행 상황을 공유하고 이슈를
                논의할 수 있는 기능을 제공함
              </li>
              <li>
                Task Chart : 전체 진척도를 분석하여 프로젝트 방향성을 점검할 수
                있도록 지원함. Task Chart : 전체 진척도를 분석하여 프로젝트
                방향성을 점검할 수 있도록 지원함.
              </li>
              <li>
                Member Evaluation : 팀원 간의 객관적 평가 시스템을 제공하여
                협업의 질을 향상시킴 Member Evaluation : 팀원 간의 객관적 평가
                시스템을 제공하여 협업의 질을 향상시킴
              </li>
            </ul>
          </p>,
        ],
      },
      {
        ...
        items: [
          <p key="0">
            ...
            통해 객관적 성과 관리 체계를 구축하여 평가의 신뢰성을 높임 프로젝트
            포트폴리오 뷰를 제공하여 전체 프로젝트 현황을 통합 관리함. 참여 중인
            모든 프로젝트의 실시간 진행 상황을 모니터링하고, 프로젝트별 정량적
            성과 점수를 산출 및 추적함. 종합 포인트 시스템을 통해 객관적 성과
            관리 체계를 구축하여 평가의 신뢰성을 높임
          </p>,
        ],
      },
      {
    ...
    description: [
      {
        ...
        description: [
          <p key="0">
            ...
            직접 설계하고 구현하여 전체적인 개발 프로세스를 주도함. 프로젝트의
            핵심 기능인 워크스페이스의 목표 설정 및 로그 관리 기능을 직접
            설계하고 구현하여 전체적인 개발 프로세스를 주도함.
          </p>,
        ],
      },
      {
        ...
        description: [
          <p key="0">
            ...
            지원함 하여, 프로젝트 매니저들이 효율적으로 프로젝트를 설정할 수
            있도록 지원함
          </p>,
        ],
      },
      ...
      },
      {
        ...
        description: [
          <p key="0">
            ...
            중복되는 로그 데이터를 효과적으로 제거하는 알고리즘을 구현하여{" "}
            <span className="underline">
              데이터 처리 과정에서의 지연 시간을 30% 이상 단축함. 데이터 처리
              과정에서의 지연 시간을 30% 이상 단축함.
            </span>
            이 알고리즘은 특정 조건에 맞는 중복 데이터를 필터링하는 방식으로
            작동하여, 전체 로그의 품질과 효용성을 크게 향상시킴 이 알고리즘은
            특정 조건에 맞는 중복 데이터를 필터링하는 방식으로 작동하여, 전체
            로그의 품질과 효용성을 크게 향상시킴
          </p>,
      ...
      },
      {
        ...
        description: [
          <p key="0">
            ...
            중 하나인 목표 설정 및 요약 페이지의 커스터마이징을 지원함 기초 초안
            및 프로젝트에 필요한 다양한 내용에 대한 예제와 형식을 제공함으로써,
            PPM(Project Portfolio Management)에서 가장 중요한 기능 중 하나인
            목표 설정 및 요약 페이지의 커스터마이징을 지원함
          </p>,
          <p key="1">
            기존 PPM 모델에서 필요한 프로젝트 초기 설정 기능을 제공함으로써, 이
            기능을 사용하여 초기 설정을 완료하는 비율이 기존 PPM 모델에서 필요한
            프로젝트 초기 설정 기능을 제공함으로써, 이 기능을 사용하여 초기
            설정을 완료하는 비율이{" "}
            <span className="underline">
              전체 프로젝트의 50% 이상에 달하는 높은 사용률을 기록함 전체
              프로젝트의 50% 이상에 달하는 높은 사용률을 기록함
            </span>
          </p>,
        ],
      },
      {
        ...
        description: [
          <p key="0">
            ...
            주도함. 마케팅 및 TE 팀과 협업하여 사용자 피드백을 기반으로 활동
            로그를 설계함. 중간중간 스프린트를 통해 대표님 및 각 팀장님에게
            기획안과 기능 설명을 진행하며, 개발팀, 디자인팀과 마케팅팀 간의
            원활한 소통을 주도함.{" "}
          </p>,
          <p key="1">
            {" "}
            ...
            요구 사항을 충족시키기 위해 노력함. 다양한 팀원들과 협력하여
            효율적인 프로젝트 기획 및 협업 기술을 향상시킴. 팀 간의 소통을 통해
            프로젝트 목표를 명확히 하고, 각 팀의 요구 사항을 충족시키기 위해
            노력함.{" "}
          </p>,
        ],
      },
